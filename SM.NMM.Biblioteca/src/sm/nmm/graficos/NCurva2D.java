...
/**
 * Clase personalizada que sustituye a QuadCurve2D
 * @author mmnuria
 */
public class NCurva2D extends QuadCurve2D.Float implements NShape {
    ...
    /**
     * Constructor
     * @param p1 punto inicial de la figura (pressed)
     * @param p2 punto de control de la figura (paso2)
     * @param p3 punto final de la figura (dragged)
     */
    public NCurva2D(Point p1, Point p2, Point p3){
    ...
    /**
     * Método que calcula la nueva posición de la curva al moverla
