...
/**
 * Clase personalizada que sustituye a Ellipse2D
 * @author mmnuria
 */
public class NElipse2D extends Ellipse2D.Float implements NShape{
     ...
     */
    public NElipse2D(float x, float y, float w, float h){
        super(x,y,w,h);
