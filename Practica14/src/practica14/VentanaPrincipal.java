...
import sm.nmm.imagen.PosterizarOp;
import sm.nmm.imagen.RojoOp;
import sm.nmm.imagen.TonoOp;
...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    /**
     * Imagen original antes de aplicar posterizar. Esta imagen se conserva para
     * poder restaurarla o compararla con las versiones modificadas.
     */
    private BufferedImage imgPosterizar;

    /**
     * Imagen original antes de aplicar el cambio de tono. Esta imagen se
     * conserva para poder restaurarla o compararla con las versiones
     * modificadas.
     */
    private BufferedImage imgOriginalTono;

    /**
     * Indicador booleano que señala si el modo del cambio de tono con umbral
     * está activo o no. Cuando es true, el modo ABC está activo, si no, está
     * desactivado.
     */
    private boolean modoOperadorActivo = false;
    ...
    public VentanaPrincipal() {
        ...
        sliderDesplazamiento.setEnabled(false);
    ...
    private void aplicarFiltro(String filtro) {
        ...
        switch (filtro) {
            ...
            case "Emborronamiento binomial":
                ...
                break;
            case "Enfoque (realce o perfilado)":
    ...
    private void aplicarPerfiladoInteractivo(int a) {
        ...
        ConvolveOp cop = new ConvolveOp(k, ConvolveOp.EDGE_NO_OP, null);
        BufferedImage filtrada = cop.filter(imgPerfilar, null);
    ...
    /**
     * Aplica un filtro de tono personalizado a la imagen actualmente visible en
     * la ventana interna activa del escritorio, utilizando un umbral de color y
     * un desplazamiento definidos.
     *
     * Este método toma la imagen original almacenada en `imgOriginalTono` y le
     * aplica un filtro de tipo `TonoOp`, el cual compara cada píxel con un
     * color base (`buttonColor.getBackground()`) y modifica aquellos que se
     * encuentran dentro del umbral especificado. El desplazamiento controla
     * cómo se ajusta el valor de los píxeles que cumplen la condición.
     *
     * El resultado se asigna como nueva imagen en el lienzo 2D de la ventana
     * interna activa.
     *
     * @param umbral es el valor de tolerancia al color base. Cuanto mayor sea,
     * más amplia será la gama de colores que se considerarán cercanos al color
     * de referencia.
     * @param desplazamiento es el valor que se usa para modificar los píxeles
     * que cumplen con el criterio del filtro. Puede influir en el matiz o
     * intensidad del efecto aplicado.
     */
    private void aplicarFiltroOperadorExtra(int umbral, int desplazamiento) {
        VentanaInterna vi = (VentanaInterna) escritorio.getSelectedFrame();
        if (vi != null && imgOriginalTono != null) {

            TonoOp filtro = new TonoOp(buttonColor.getBackground(), umbral, desplazamiento);
            BufferedImage imgFiltrada = filtro.filter(imgOriginalTono, null);
            vi.getLienzo2D().setImage(imgFiltrada);
            escritorio.repaint();
        }
    }
    ...
    private void initComponents() {
        ...
        buttonInvertirZonasOscuras = new javax.swing.JButton();
        ...
        buttonCombinarBandas = new javax.swing.JButton();
        buttonTintar = new javax.swing.JButton();
        buttonSepia = new javax.swing.JButton();
        buttonRojo = new javax.swing.JButton();
        imagenPosterizar = new javax.swing.JLabel();
        sliderPosterizar = new javax.swing.JSlider();
        buttonOperadorExtra = new javax.swing.JToggleButton();
        sliderDesplazamiento = new javax.swing.JSlider();
        ...
        itemAbrirAudio = new javax.swing.JMenuItem();
        itemAbrirVideo = new javax.swing.JMenuItem();
        ...
        comboBoxListaReproduccion.setPreferredSize(new java.awt.Dimension(70, 20));
        jToolBar1.add(comboBoxListaReproduccion);
        ...
        jToolBar1.add(buttonRecord);
        jToolBar1.add(jSeparator11);

        buttonCamara.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Camara.png"))); // NOI18N
        buttonCamara.setFocusable(false);
        buttonCamara.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        buttonCamara.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        buttonCamara.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonCamaraActionPerformed(evt);
            }
        });
        jToolBar1.add(buttonCamara);

        buttonCapturar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Capturar.png"))); // NOI18N
        buttonCapturar.setFocusable(false);
        buttonCapturar.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        buttonCapturar.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        buttonCapturar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonCapturarActionPerformed(evt);
            }
        });
        jToolBar1.add(buttonCapturar);
        ...
        buttonCombinarBandas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/combinar.png"))); // NOI18N
        buttonCombinarBandas.setFocusable(false);
        buttonCombinarBandas.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        buttonCombinarBandas.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        buttonCombinarBandas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonCombinarBandasActionPerformed(evt);
            }
        });
        jToolBar2.add(buttonCombinarBandas);
        ...
        jToolBar2.add(buttonRojo);

        imagenPosterizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/posterizar.png"))); // NOI18N
        jToolBar2.add(imagenPosterizar);

        sliderPosterizar.setMaximum(20);
        sliderPosterizar.setMinimum(2);
        sliderPosterizar.setPreferredSize(new java.awt.Dimension(50, 50));
        ...
        jToolBar2.add(sliderPosterizar);

        buttonOperadorExtra.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/paleta.png"))); // NOI18N
        buttonOperadorExtra.setFocusable(false);
        buttonOperadorExtra.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        buttonOperadorExtra.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        buttonOperadorExtra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonOperadorExtraActionPerformed(evt);
            }
        });
        jToolBar2.add(buttonOperadorExtra);

        sliderDesplazamiento.setMaximum(360);
        sliderDesplazamiento.setValue(0);
        sliderDesplazamiento.setPreferredSize(new java.awt.Dimension(50, 50));
        sliderDesplazamiento.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                sliderDesplazamientoStateChanged(evt);
            }
        });
        jToolBar2.add(sliderDesplazamiento);

        sliderUmbral.setMaximum(180);
        sliderUmbral.setValue(20);
        sliderUmbral.setPreferredSize(new java.awt.Dimension(50, 50));
        sliderUmbral.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                sliderUmbralStateChanged(evt);
            }
        });
        jToolBar2.add(sliderUmbral);
        ...
        ItemNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/nuevo.png"))); // NOI18N
        ...
        ItemAbrir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/abrir.png"))); // NOI18N
        ...
        ItemGuardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/guardar.png"))); // NOI18N
        ...
        menuArchivo.add(jSeparator9);

        itemAbrirAudio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/openAudio.png"))); // NOI18N
        itemAbrirAudio.setText("Abrir audio");
        itemAbrirAudio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itemAbrirAudioActionPerformed(evt);
            }
        });
        menuArchivo.add(itemAbrirAudio);

        itemAbrirVideo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/AbrirVideo.png"))); // NOI18N
        itemAbrirVideo.setText("Abrir video");
        itemAbrirVideo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itemAbrirVideoActionPerformed(evt);
            }
        });
        menuArchivo.add(itemAbrirVideo);
    ...
    private void buttonTintarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonTintarActionPerformed
        ...
        if (vi != null) {
            ...
            if (img != null) {
                try {
                    TintOp tintado = new TintOp(buttonColor.getBackground(), 0.5f);
    ...
    private void sliderPosterizarStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderPosterizarStateChanged
        VentanaInterna vi = (VentanaInterna) escritorio.getSelectedFrame();
        if (vi != null && imgPosterizar != null) {
            BufferedImage img = imageCopy(imgPosterizar);
            if (img != null) {
                try {
                    int niveles = sliderPosterizar.getValue();
                    PosterizarOp op = new PosterizarOp(niveles);
                    op.filter(imgPosterizar, img);
                    vi.getLienzo2D().setImage(img);
                    escritorio.repaint();
                } catch (IllegalArgumentException e) {
                    System.err.println(e.getLocalizedMessage());
    ...
    private void buttonOperadorExtraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOperadorExtraActionPerformed
        modoOperadorActivo = buttonOperadorExtra.isSelected();

        VentanaInterna vi = (VentanaInterna) escritorio.getSelectedFrame();
        if (vi != null) {
            if (modoOperadorActivo) {
                // Habilitar sliders
                sliderDesplazamiento.setEnabled(true);
                sliderUmbral.setEnabled(true);

                // Guardar imagen original para no perderla
                imgOriginalTono = vi.getLienzo2D().getImage();

                // Aplicar filtro con valores actuales de sliders
                int umbral = sliderUmbral.getValue();
                int desplazamiento = sliderDesplazamiento.getValue();
                aplicarFiltroOperadorExtra(umbral, desplazamiento);
            } else {
                // Deshabilitar sliders
                sliderDesplazamiento.setEnabled(false);
                sliderUmbral.setEnabled(false);
                ...
                if (imgOriginalTono != null) {
                    vi.getLienzo2D().setImage(imgOriginalTono);
                    escritorio.repaint();
                    imgOriginalTono = null;
                }
            }
        }
    }//GEN-LAST:event_buttonOperadorExtraActionPerformed

    private void sliderDesplazamientoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderDesplazamientoStateChanged
        if (modoOperadorActivo && imgOriginalTono != null) {
            int umbral = sliderUmbral.getValue();
            int desplazamiento = sliderDesplazamiento.getValue();

            aplicarFiltroOperadorExtra(umbral, desplazamiento);
        }
    }//GEN-LAST:event_sliderDesplazamientoStateChanged
    ...
    private void sliderUmbralStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderUmbralStateChanged
        if (modoOperadorActivo && imgOriginalTono != null) {
            ...
            // Obtener la imagen actual y aplicar filtro con esos parámetros
            aplicarFiltroOperadorExtra(umbral, desplazamiento);
        }
    ...
    private void buttonCombinarBandasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCombinarBandasActionPerformed
        VentanaInterna vi = (VentanaInterna) escritorio.getSelectedFrame();
        ...
        if (vi != null) {
            ...
            if (img != null) {
                try {
                    ...
                    System.err.println("Error combinando bandas: " + e.getMessage());
                }
            }
        }
    }//GEN-LAST:event_buttonCombinarBandasActionPerformed

    private void itemAbrirAudioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemAbrirAudioActionPerformed
        JFileChooser dlg = new JFileChooser();
        ...
        if (resp == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                this.comboBoxListaReproduccion.setSelectedItem(f);
            } catch (Exception ex) {
                System.err.println("Error al leer sonido");
            }
        }

        LabelBarraDeEstado.setText("Abriendo audio");
    }//GEN-LAST:event_itemAbrirAudioActionPerformed

    private void buttonPlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonPlayActionPerformed
        File f = (File) comboBoxListaReproduccion.getSelectedItem();
        if (f != null) {
            player = new SMClipPlayer(f);
            if (player != null) {
                player.addLineListener(new ManejadorAudio());
                player.play();
                LabelBarraDeEstado.setText("Reproduciendo audio");
            }
        }
        VentanaInternaVideo vv = (VentanaInternaVideo)escritorio.getSelectedFrame();
        if(vv != null){
            vv.play();
            LabelBarraDeEstado.setText("Reproduciendo video");
        }
    ...
    private void buttonStopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonStopActionPerformed
        if (player != null) {
            player.stop();
            player = null;
            LabelBarraDeEstado.setText("Parando audio");
        }
        if (recorder != null) {
            recorder.stop();
            recorder = null;
            LabelBarraDeEstado.setText("Parando grabación");
        }
        VentanaInternaVideo vv = (VentanaInternaVideo)escritorio.getSelectedFrame();
        if(vv != null){
            vv.stop();
            LabelBarraDeEstado.setText("Parando video");
        }
    ...
    private void buttonRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRecordActionPerformed
        ...
        if (resp == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                LabelBarraDeEstado.setText("Grabando audio");
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Error al iniciar la grabación.\n" + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            LabelBarraDeEstado.setText("Grabación cancelada");
        }
    ...
    private void buttonCamaraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCamaraActionPerformed
        ...
        if(vc != null){
            escritorio.add(vc);
            vc.setVisible(true);
            LabelBarraDeEstado.setText("Abriendo camara");
        }
    ...
    private void buttonCapturarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCapturarActionPerformed
        ...
        if(vc !=null){
            ...
            escritorio.add(vi);
            vi.setVisible(true);
            LabelBarraDeEstado.setText("Haciendo captura");
        }
    }//GEN-LAST:event_buttonCapturarActionPerformed

    private void itemAbrirVideoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemAbrirVideoActionPerformed
        JFileChooser dlg = new JFileChooser();
        int resp = dlg.showOpenDialog(this);
        if (resp == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                System.err.println("Error al leer video");
            }
        }

        LabelBarraDeEstado.setText("Abriendo video");
    }//GEN-LAST:event_itemAbrirVideoActionPerformed
    ...
    private javax.swing.JButton buttonCombinarBandas;
    ...
    private javax.swing.JButton buttonInvertirZonasOscuras;
    private javax.swing.JToggleButton buttonLinea;
    private javax.swing.JButton buttonNuevo;
    private javax.swing.JToggleButton buttonOperadorExtra;
    ...
    private javax.swing.JLabel imagenPosterizar;
    private javax.swing.JMenuItem itemAbrirAudio;
    private javax.swing.JMenuItem itemAbrirVideo;
    ...
    private javax.swing.JSlider sliderDesplazamiento;
